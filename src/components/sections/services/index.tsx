...
export const ServicesSection = () => {
	return (
		<SectionContainer id="services" className={styles.services}>
			<SectionHeader
				...
				>
					...
					<div className={styles.cardContent}>
						...
						<p className={styles.cardDescription}>
							Herreklip og dameklip, barbering, VIP-behandlinger
							og mere – af erfarne frisører med øje for detaljen
						</p>
